...
<FormField
        ...
        render={({ field }) => (
          <FormItem className='flex flex-col gap-1'>
            ...
            <FormControl >
              <Input type="number" min={1} max={5} required placeholder='Book rating' {...field} className='book-form_input' />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
...
<FormField
        ...
        render={({ field }) => (
          <FormItem className='flex flex-col gap-1'>
            ...
            <FormControl >
              <Input type="number" min={1} max={10000} required placeholder='Total Copies' {...field} className='book-form_input' />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
